...
namespace Hospital.Controllers
{
    public class EspecialidadesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DescEspec")] Especialidade especialidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DescEspec")] Especialidade especialidade)
        {
